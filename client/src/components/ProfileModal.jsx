  ...
  return (
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4" onClick={(e) => e.target === e.currentTarget && onClose()}>
      <div className="bg-white rounded-2xl p-8 w-full max-w-md relative max-h-[90vh] overflow-y-auto">
        ...
        <h2 className="text-lg font-bold mb-1">Mi perfil</h2>
        <p className="text-sm text-gray-500 mb-6">Editá tu información personal</p>
        ...
        <form onSubmit={handleSave} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Field label="Profesión" value={form.profession} onChange={(v) => setForm({ ...form, profession: v })} />
          </div>
        ...
        <h3 className="text-sm font-bold mb-3">Cambiar contraseña</h3>
